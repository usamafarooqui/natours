...
exports.logout=(req , res)=>{
    // http only ki waja se cookie manuplate ya delete nahi kr saktay 
    // is liye cookie ko overwrite kr rahay hn
    // jwt cookiw namwe logout esay hi text hai instead of cookiw
    // jb ye jwt se match nahi krega tou logout hojayega user
